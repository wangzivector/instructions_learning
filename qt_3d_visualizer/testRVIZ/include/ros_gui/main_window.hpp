...
public:
    RvizPlugin(QVBoxLayout* ui){
        ...
        enablePointCloud2("/kinect_pointcloud/keypoints/points", "FlatColor", "1");
        rviz::Display* frameRgister=enablePointCloud2("/kinect_pointcloud/keypoints/points_full", "RGB8", "2");
